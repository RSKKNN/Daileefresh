...
const {scrollY} = useViewportScroll();
 const y1 = useTransform(scrollY, [0, 2000], [0,2000 ]);
  ...
  const scale = useTransform(scrollY, [100,200,400,1300], [20,15,10,2]);
...
const l = useTransform(scrollY,[0,1000,1500,2000,3000],[-2500,-1000,-250,-250,250])
const r = useTransform(scrollY,[0,1000,1500,2000,3000],[2500,1000,250,250,-250])
...
const boxlemony = useTransform(scrollY,[4000,5500,6000,6500],[5000,5500,6000,3400])
...
const otextx = useTransform(scrollY,[6000,7000,8000],[-1000,0,0])
...
const rib1 = useTransform(scrollY,[1200,1600],[-5000,-1400])
const rib2 = useTransform(scrollY,[1200,1600],[5000,1400])


//mnbk
const manbky = useTransform(scrollY,[0,10000],[0,10000])
const manbkop = useTransform(scrollY,[0,2000],[0,1])
...
const mandesy = useTransform(scrollY,[1500,2000],[1500,2000])
    ...
    return (
        ...
        <motion.div className='home' >
          ...
          < motion.img className="grid" src="./grid.png" alt="" />
        <motion.img className="manbk"style={{scale:"0.2",opacity:manbkop}}src="./manbk" alt="" />

          <motion.h1 className="MangoText" style={{y:mtx, scale:0.4 ,x:-500,marginTop:-140}}> MANGO</motion.h1>
          <motion.h1 className="LemonadeText" style={{y:ldtx,scale:0.4 ,x:-550}}> LEMONADE</motion.h1>
          <motion.h1 className="LemonText" style={{y:lemony,scale:0.4 ,x:-500}}> LEMON</motion.h1>
          <motion.h1 className="OrangeText" style={{x:otextx,y:otexty, scale:0.3}}> ORANGE</motion.h1>
          <motion.h1 className="AppleText" style={{y:10000}}> APPLE</motion.h1>
            ...
            }} src="./verMango2.png" alt=""/>

           <motion.img className='rib' style={{y:enrich,x:rib1,rotate:-5,rotateX:enrichrot }}src="./rib" alt="" />
           <motion.img className='rib2' style={{y:enrich,x:rib2,rotate:-5,rotateX:alprot, }}src="./rib" alt="" />

            <motion.alpha1 className='alpha1' style={{y:enrich,x:l,rotateX:enrichrot ,scale:0.3}}>ENRICH</motion.alpha1>
            <motion.alpha2 className='alpha2' style={{y:alp, x:r,rotateX:alprot, scale:0.3}}>ALPHONSSO</motion.alpha2>
            <motion.h1 className="Mandes" style={{y:mandesy}}>Are You Craving For A Mango Delight? Dailee Presents The Real Mango Drink. This Summer Relish The Goodness Of Alphonso Pulps Mess Free In Bottles. Feel The Royalty From The Extravagance Of The King Of The Fruits. A Cheeky Drink For The Exquisite Individuals!</motion.h1>
...
<motion.div style={{x:45, opacity:appupop}}>
...
<motion.div className="Applsw" style={{ }}>
            ...
            <motion.img className='family' style={{y:y2,x:0}} src="./dailyfamily1.png" alt="" />
